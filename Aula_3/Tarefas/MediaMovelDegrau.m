...
filewrite = fopen('DegrauUnitarioFiltered13.pcm', 'w');      % Abrindo o arquivo a ser escrito apos passar pela MM
fileread = fopen('DegrauUnitario.pcm', 'r');               % Abrindo o arquivo de degrau unitario pcm
